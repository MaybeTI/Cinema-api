...
from cinema.management.commands.movie_image_file import movie_image_file_path
...
class MovieSession(models.Model):
    ...
    movie = models.ForeignKey(
        Movie, on_delete=models.CASCADE, related_name="MovieSessions"
    )
    cinema_hall = models.ForeignKey(
        CinemaHall, on_delete=models.CASCADE, related_name="MovieSessions"
    )
